...
RCPLabel <- reactive({ switch(input$rcp, "Low (RCP 4.5)"="Low-Range Emissions (RCP 4.5)", "Medium (RCP 6.0)"="Mid-Range Emissions (RCP 6.0)", "High (RCP 8.5)"="High-Range Emissions (RCP 8.5)") })
