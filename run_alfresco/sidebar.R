	...
	conditionalPanel(condition="input.tsp!=='info'",
		wellPanel(
			...
			fluidRow(
				...
				column(4, selectInput("FireSensFMO", "Sens. FMO", c("None", "Standard", "5-km buffered full", "5-km buffered full noCrit", "15-km buffered"), width="100%")),
			...
			fluidRow(
			  ...
			  column(4, selectInput("IgnitFacFMO", "Ignit. FMO", c("None", "Standard", "5-km buffered full", "5-km buffered full noCrit", "15-km buffered"), width="100%")),
