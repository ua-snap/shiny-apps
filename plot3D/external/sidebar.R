sidebarPanel(
	...
	conditionalPanel(condition="input.tsp!=='rcode'",
		...
		wellPanel(
			checkboxInput("showWP6",h5("General properties"),TRUE),
	...
	conditionalPanel(condition="input.tsp==='rcode'",
		navlistPanel(
			"Top-level Code",
			tabPanel("Global", value="nlp_global"),
			tabPanel("UI", value="nlp_ui"),
			tabPanel("Server", value="nlp_server"),
			"Mid-level Code",
			tabPanel("App", value="nlp_app"),
			tabPanel("Header", value="nlp_header"),
			tabPanel("Sidebar", value="nlp_sidebar"),
			tabPanel("Main", value="nlp_main"),
			tabPanel("About", value="nlp_about"),
			"Bottom-level Code",
			tabPanel("Well Panel 1", value="nlp_wp1"),
			tabPanel("Well Panel 2", value="nlp_wp2"),
			tabPanel("Well Panel 3", value="nlp_wp3"),
			tabPanel("Well Panel 4", value="nlp_wp4"),
			tabPanel("Well Panel 5", value="nlp_wp5"),
			tabPanel("Well Panel 6", value="nlp_wp6"),
			tabPanel("Reactives", value="nlp_reactives"),
			id="nlp",
			widths=c(12,1)
		),
		#uiOutput("HighlightTheme"),
