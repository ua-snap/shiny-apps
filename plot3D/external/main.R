mainPanel(
	tabsetPanel(
		...
		tabPanel("R Code",
			...
			conditionalPanel(condition="input.nlp==='nlp_wp1R'", show_io.sidebar.wp1R),
			conditionalPanel(condition="input.nlp==='nlp_wp2R'", show_io.sidebar.wp2R),
			conditionalPanel(condition="input.nlp==='nlp_wp3R'", show_io.sidebar.wp3R),
			conditionalPanel(condition="input.nlp==='nlp_wp4R'", show_io.sidebar.wp4R),
			conditionalPanel(condition="input.nlp==='nlp_wp5R'", show_io.sidebar.wp5R),
			conditionalPanel(condition="input.nlp==='nlp_wp6R'", show_io.sidebar.wp6R),
