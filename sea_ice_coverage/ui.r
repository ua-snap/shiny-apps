...
shinyUI(fluidPage(theme = shinytheme("spacelab"), 
	headerPanel_2(
		HTML('Modeled Arctic Sea Ice Coverage
			<a href="http://accap.uaf.edu" target="_blank"><img id="stats_logo" align="right" style="margin-left: 15px;" src="./img/ACCAP_acronym_100px.png" /></a>
			<a href="http://snap.uaf.edu" target="_blank"><img id="stats_logo" align="right" src="./img/SNAP_acronym_100px.png" /></a>'
