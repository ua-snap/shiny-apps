function(){
	tabPanel("About",
		...
		Fitted trend model output is displayed below the plot for each climate model and regression model.</p>
		...
		As such, there are no plans for continued development or refinement of this particular app. However, future apps for other projects will be able to build upon what has been done here.</p>
