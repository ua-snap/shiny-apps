function(){
	tabPanel("About",
	div(style="background-color:#000000; opacity:0.9; padding: 25px 25px 25px 25px; height: 800px;",
		...
		At this point everything is in place to run ALFRESCO. The final system() call made by R in the app is to launch a SLURM script via sbatch on Atlas.'),
		...
		with a Eris url being emailed to the user.'),
		br(),
