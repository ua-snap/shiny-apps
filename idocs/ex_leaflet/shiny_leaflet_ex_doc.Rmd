...
This app is written in the [R programming language](https://www.r-project.org/) and built with the [Shiny](https://shiny.rstudio.com/)
web application framework for R. Is your organization looking for similar web applications or dashboards for your data and analytics needs?
SNAP designs R Shiny apps and other web-based tools and software ranging from simple to complex and suitable for a variety of stakeholders
whose purposes include public outreach and scientific communication, directly supporting scientific research,
and organizational data access and analytics. [Contact us](https://www.snap.uaf.edu/about/contact/) for details.
