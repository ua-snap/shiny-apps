...
library(knitr)
wd <- getwd()
opts_chunk$set(cache=FALSE, eval=TRUE, message=FALSE, warning=FALSE, root.dir=normalizePath(wd))
...
```{r, echo=FALSE}
shinyAppFile(files[1], options=list(width="100%", height=400, wd="/var/www/shiny-server/shiny-apps/ex/leaflet"))
```
