...
library(knitr)
opts_chunk$set(cache=FALSE, eval=TRUE, messages=FALSE, warnings=FALSE)
...
The app does not much in this version, but it provides a clear view of how to use observers in Shiny apps to ensure that various inputs and outputs remain mutually well behaved.
