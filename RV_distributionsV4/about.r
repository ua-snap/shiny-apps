function(){
	tabPanel("About",
		...
		<p style="text-align:justify">This R Shiny application is version four of an expanding app intended for showing various ways of adding 
		...
		(almost entirely) base R functions.</p>
		...
		I would be happy for any suggestions of ways to improve my code.</p>
		<p style="text-align:justify">This app (and those before it) represents some of my earliest explorations with Shiny.
		Although I have maintained the app as the Shiny package has continued to develop, the app is not meant to suggest all best practices, nor does it include usage of some Shiny coding preferences I picked up later.</p>
		<br/>'),
